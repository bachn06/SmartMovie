...
struct PopularViewEntity {
}

final class PopularModel {
...
extension PopularModel: PopularModelProtocol {
    func getListMovie(page: Int, completion: @escaping (Result<[MovieResponseEntity], APIError>) -> Void) {
        listMoviesAPI.getListMovies(endPoint: EndPoint.popular.rawValue,
